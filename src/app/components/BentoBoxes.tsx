...
const BentoBoxes = () => {
    return (
        <div className="p-8 py-16 bg-[#fff] w-full h-max flex flex-col items-center">
            <h2 className="text-5xl text-center font-bold mb-12 text-[#fd3725]">
                Find Your Furr Friend
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-6xl justify-items-center">
                {/* Cat Card */}
                <div className="w-72 h-72 lg:w-96 lg:h-96 bg-[#2925fd] rounded-full overflow-hidden relative group cursor-pointer shadow-xl">
                    <PawPattern />
                    <Link href="/store">
