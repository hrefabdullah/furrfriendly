        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="sm:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
            ...
            <ClickSpark
              ...
              <div className="lg:text-left md:mt-5 mt-2">
                <button className="bg-[#f72630] text-white px-4 py-2 md:px-6 md:py-3 rounded-lg md:text-lg font-medium hover:bg-red-600 transition">
                  Shop Now
                </button>
              </div>
            </ClickSpark>
          ...
          <div className="sm:w-1/2 relative w-full h-[50vh] md:h-150 lg:h-155 mr-6">
            ...
            <svg className="absolute inset-0 w-[80%] lg:w-[90%] h-full left-12 top-[-20px] rotate-7" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path fill="#f72630" d="M66.6,-36.9C75.8,-22.7,65.3,4.5,50.9,28.6C36.5,52.7,18.3,73.7,-0.9,74.2C-20.1,74.9,-40.1,54.8,-48.3,34.2C-56.5,13.9,-52.9,-7.4,-42.9,-22.2C-32.8,-37,-16.4,-45.5,6.2,-49C28.8,-52.6,57.5,-51.2,66.6,-36.9Z" transform="translate(100 100)" />
            </svg>
            <Image
              src="/assets/cat.png"
              alt="cat"
